...
namespace AIS
{
    public partial class FormStepByStep : Form
    {
        ...
        /// <summary>Работает ли алгоритм в данный момент</summary>
        bool flag = false;
        bool[] Red = new bool[5];
        ...
        /// <summary>Стрелочки, показывающие активный шаг</summary>
        private void pictureBox3_Paint(object sender, PaintEventArgs e)
        {
            ...
            //Проверка условия окончания ->  Селекция 
