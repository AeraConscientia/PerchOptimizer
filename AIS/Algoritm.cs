...
namespace AIS
{
    ...
    public class Algoritm
    {
        ...
        /// <summary>Популяция волков </summary>
        ...
        public void Selection()
        {
            ...
            //Выбираем наиболее приспосоленных (сделано так, чтобы была передача значений, а не ссылки) 
        ...
        /// <summary>Формирование новой стаи</summary>
        ...
        /// <summary>Старт алгоритма</summary>
        public Wolf StartAlg(int population, int MaxCount, double[,] D, int f, Params param)
        //public Wolf StartAlg(int MaxCount, double[,] D, int f, Params param)
        {
            this.param = param;
